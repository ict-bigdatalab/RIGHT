...
python3 main.py --dataset THG \
    --exp_version lr_3e-4_bs32_epoch30_bertfinetuningretrieval_concatall \
    ...
    --retrieval_index_path_for_train data/THG_twitter/twitter.2021.train.src_after_cleaning.txt_bert_dense_score.json \
    --retrieval_index_path_for_val data/THG_twitter/twitter.2021.valid.src_after_cleaning.txt_bert_dense_score.json \
    --retrieval_index_path_for_test data/THG_twitter/twitter.2021.test.src_after_cleaning.txt_bert_dense_score.json \
