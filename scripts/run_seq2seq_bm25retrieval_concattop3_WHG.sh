...
python3 main.py --dataset WHG \
    --exp_version lr_3e-4_bs18_epoch10_bm25retrieval_concattop3 \
    ...
    --retrieval_index_path_for_train data/WHG/new4_train.src_after_cleaning.txt_bm25_score.json \
    --retrieval_index_path_for_val data/WHG/new4_validation.src_bm25_score.json \
    --retrieval_index_path_for_test data/WHG/new4_test.src_bm25_score.json \
