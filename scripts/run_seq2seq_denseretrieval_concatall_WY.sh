...
python3 main.py --dataset WY \
    --exp_version lr_1e-4_bs12_epoch30_seq2seq_dense_concatall \
    ...
    --retrieval_index_path_for_train data/Twitter_naacl_wangyue/train_src.txt_dense_score.json \
    --retrieval_index_path_for_val data/Twitter_naacl_wangyue/valid_src.txt_dense_score.json \
    --retrieval_index_path_for_test data/Twitter_naacl_wangyue/test_src.txt_dense_score.json \
